...
var Browser = (function () {
    ...
    Browser.matchAgainstString = function (rules, userAgent) {
    ...
    Browser.match = function (regex, userAgent) {
        regex = regex.replace('/', '\/');
        var regexPattern = new RegExp(regex, 'gi');
        return userAgent.match(regexPattern) == null ? false : true;
    };
    Browser.prototype.parseUserAgent = function (userAgent, platform) {
        ...
        return {
            ...
            version: parseFloat(((userAgentArray[1] == 'opera' && userAgentArray[4]) ? userAgentArray[4] : userAgentArray[2])),
            platform: '' + platform
        };
    };
    /**
     ...
     * @returns {boolean}
     */
    Browser.prototype.isTablet = function () {
     ...
     * @returns {boolean}
     */
    Browser.prototype.isPhone = function () {
     ...
     * @returns {boolean}
     */
    Browser.prototype.isIPhone = function () {
